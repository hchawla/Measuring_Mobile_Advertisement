...
CREATE TABLE `Ad_Requests` (
  ...
  `HTTP_SEQ` int(11) DEFAULT NULL,
  `LEN_TCP` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
LOCK TABLES `Ad_Responses` WRITE;
/*!40000 ALTER TABLE `Ad_Responses` DISABLE KEYS */;
/*!40000 ALTER TABLE `Ad_Responses` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-17 13:55:09
